...
//GSChatIMAPNS generate by objrpc
@protocol GSChatIMAPNS<NSObject>
...
// GSChatIMAPNSService generate by objrpc
@interface GSChatIMAPNSService : NSObject<GSDispatcher>
...
@interface GSChatIMAPNSRPC : NSObject
+ (instancetype) initRPC:(id<GSChannel>) channel withID:(UInt16) serviceID;
